					...
					<div class="col-md-2">
						<div class="form-group">
							<label for="orderid">ORDER ID</label> <input type="text"
								class="form-control" id="orderid" placeholder="orderid"
								name="name" />
						</div>
					</div>
					<div class="col-md-2">
						<div class="form-group">
							<label for="invoice">INVOICE</label> <input type="text"
								class="form-control" id="invoice" placeholder="INVOICE"
					...
					<div class="col-md-2">
						<div class="form-group">
							<label for="msisdn">MSISDN</label> <input type="text"
								class="form-control" id="msisdn" placeholder="MSISDN"
								name="msisdn" />
						</div>
					</div>
					<div class="col-md-2">
						<div class="form-group">
							<label for="activation">ACTIVATION</label> <input type="text"
								class="form-control" id="activation" placeholder="Activation"
								name="activation" />
						</div>
					</div>
					<div class="col-md-2">
						<div class="form-group">
							<label for="addr">DELIVERY STATUS</label> <input type="text"
								class="form-control" id="disabledInput"
								placeholder="DELIVERY STATUS" name="delivery Status" disabled />
						</div>
					</div>
					<div class="col-md-2">
						<div class="form-group">
							<label for="action">ACTION</label> <input type="button"
								class="form-control" id="action" placeholder="ACTION"
								name="action" />
						</div>
					</div>
				</form>
