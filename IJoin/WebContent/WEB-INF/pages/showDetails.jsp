...
<body>
	<div class="container">
		<div class="row">
			<div class="col-md-14 " style="padding-top: 6em;">
						...
						<div class="row">
							...
							<div class="col-md-2">
								...
								<form>
									...
									<div class="form-group">
										<a href="">Click here for tracking in web</a>
									</div>
								</form>
							</div>
							<div class="col-md-3">
								<form>
									...
									<div class="form-group">
										...
										<textarea rows="2" cols="37" value=${list[0]["SHIP_ADDRESS"]} disabled="disabled"></textarea>
									</div>
								</form>
							</div>
							<div class="row">
								<div class="col-md-5">
									<div class="col-md-7">
										<form>
											...
											<div class="form-group">
												<label for="birthPlace">Place Of Birth</label> <input
													type="text" class="form-control" id="birthPlace"
													value=${list[0]["PLACE_OF_BIRTH"]} disabled="disabled">
											</div>
											<div>
												<label for="custPic">Customer Picture</label><br>
												<img src='${list[0]["cust_img"]}' height="130" width="250"
													border="5">
											</div>
											<div class="form-group">
												<label for="customerAddress">Customer Address</label>
												<textarea rows="2" cols="65" value=${list[0]["ADDRESS"]} disabled="disabled"></textarea>
											</div>
										</form>
									</div>
									<div class="col-md-5">
										<form>
											...
											<div class="form-group">
													...
													<img src='${list[0]["id_img"]}' height="130" width="150" border="5">
