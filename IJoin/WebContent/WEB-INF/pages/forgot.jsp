...
<div class="container">
  ...
  <div class="panel panel-info">
		  <div class="panel-heading">
		    <h3 class="panel-title">Enter user id and msisdn</h3>
		  </div>
		...
		<div class="row">
			 ...
			 <div class="form-group">
                       <label for="action" class="col-sm-4 control-label"></label>
                         <div class="col-sm-8">
						<input type="hidden" class="form-control" name="action" id="action" value="forgot"/>
					</div>
					</div>
                </div>
				</div>
	...
	<div class="row">
			...
			<div class="col-md-4">
			 ...
			 <div class="form-group">
						...
						<input class="btn btn-default" type="submit" value="submit"  class="btn"/>
					  ...
					  <div class="col-sm-3">
						...
						<input class="btn btn-default" type="reset" value="Reset "  class="btn"/>
