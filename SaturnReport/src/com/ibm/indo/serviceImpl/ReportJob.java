...
public class ReportJob implements Job 
{
	...
	public void execute(JobExecutionContext context)	throws JobExecutionException {
		log.info("ReportJob.execute() - start- ");
				try {
					
					//PostURL("https://mobileagent.indosatooredoo.com/IndoReports/service/mulOrderStatus");
					//PostURL("http://10.128.168.2:8080/SaturnReport/service/dailyReport");
					log.info("Service get called === http://10.128.168.2:8080/SaturnReport/service/dailyReport");
				} catch (Exception e) {
					log.error(IndoUtil.getFullLog(e));
				}
				
		log.info("ReportJob.execute() - end- ");		
	}
	public void PostURL(String url) {
        ...
        try {
          ...
          //  String url = "URL_HERE";
        	...
        	try{
        		if(null!=in){in.close();}if(null!=w){w.close();}if(null!=con){con.disconnect();}
        	}catch(Exception ce){}
        }
    }
}
