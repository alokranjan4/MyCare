	 ...
	 public static   IndoServiceProperties  getInstance()
	    ...
	    public Properties getConfigSingletonObject(){
	    	...
	    	try {
	    		...
	    		System.out.println("Properties loaded in configProperties.");
			} catch (Exception e) {
				System.out.println("Exception from PROPERTIES. Properties is not found."+e.getMessage());
			}
	        return configProp;
	    }
	    ...
	    public static void main(String[] args) {
	    	...
	    	System.out.println(prop.getProperty("Testconfig"));
		}
}
